...
namespace Admissions_Reserve.View
{
    public partial class AdditionalInfoPage : Page
    {
        ...
        public class LanguageViewModel
        {
            ...
            public int? LanguageId { get; set; }  // Изменено с int на int?
            public string Language { get; set; }
            public int? LevelId { get; set; }     // Изменено с int на int?
            public string Level { get; set; }
            public bool? IsPrimary { get; set; }  // Изменено с bool на bool?
        }
